...
import static tech.devgao.artemis.util.bytes.BytesValue.fromHexStringLenient;
import static tech.devgao.artemis.util.bytes.BytesValue.wrap;
import static tech.devgao.artemis.util.bytes.BytesValue.wrapBuffer;

import tech.devgao.artemis.crypto.BouncyCastleMessageDigestFactory;
...
public class BytesValueTest {
  ...
  public void update() throws NoSuchAlgorithmException {
    ...
    MessageDigest md1 = BouncyCastleMessageDigestFactory.create("SHA-1");
    MessageDigest md2 = BouncyCastleMessageDigestFactory.create("SHA-1");
    MessageDigest md3 = BouncyCastleMessageDigestFactory.create("SHA-1");
    MessageDigest md4 = BouncyCastleMessageDigestFactory.create("SHA-1");

    byte[] toDigest = new BigInteger("12324029423415041783577517238472017314").toByteArray();
    BytesValue wrapped = wrap(toDigest);
