...
package tech.devgao.artemis.util.bytes;

import static org.junit.Assert.assertEquals;
import static tech.devgao.artemis.util.bytes.BytesValue.fromHexString;
import static tech.devgao.artemis.util.bytes.BytesValues.asSignedBigInteger;
import static tech.devgao.artemis.util.bytes.BytesValues.asUnsignedBigInteger;
import static tech.devgao.artemis.util.bytes.BytesValues.concatenate;
import static tech.devgao.artemis.util.bytes.BytesValues.extractInt;
import static tech.devgao.artemis.util.bytes.BytesValues.extractLong;
import static tech.devgao.artemis.util.bytes.BytesValues.ofUnsignedShort;
import static tech.devgao.artemis.util.bytes.BytesValues.toMinimalBytes;
import static tech.devgao.artemis.util.bytes.BytesValues.trimLeadingZeros;
...
public class BytesValuesTest {
  ...
  public void hexConcatenate() {
    ...
    int valCount = 10;
    BytesValue[] values = new BytesValue[valCount];
