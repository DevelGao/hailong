...
import tech.devgao.artemis.util.bytes.Bytes1;
import tech.devgao.artemis.util.bytes.Bytes3;
import tech.devgao.artemis.util.bytes.Bytes32;
import tech.devgao.artemis.util.bytes.Bytes32s;
import tech.devgao.artemis.util.bytes.Bytes48;
import tech.devgao.artemis.util.bytes.BytesValue;
import tech.devgao.artemis.util.bytes.BytesValues;
import tech.devgao.artemis.util.bytes.MutableBytes1;
import tech.devgao.artemis.util.bytes.MutableBytes3;
import tech.devgao.artemis.util.bytes.MutableBytes32;
import tech.devgao.artemis.util.bytes.MutableBytes48;
