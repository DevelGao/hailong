...
import tech.devgao.artemis.util.bytes.Bytes32Backed;
...
public interface UInt256Value<T extends UInt256Value<T>> extends Bytes32Backed, Comparable<T> {
  ...
  default T dividedCeilBy(long value) {
    T res = dividedBy(value);
