...
import static tech.devgao.hailong.datastructures.util.BeaconStateUtil.bytes_to_int;
...
import static tech.devgao.hailong.util.config.Constants.COMMITTEE_INDEX_SUBSCRIPTION_LENGTH;
import static tech.devgao.hailong.util.config.Constants.DOMAIN_BEACON_ATTESTER;
import static tech.devgao.hailong.util.config.Constants.TARGET_AGGREGATORS_PER_COMMITTEE;
...
import tech.devgao.hailong.statetransition.CommitteeAssignment;
