...
usage() {
  echo "Runs a simulation of hailong with NODES number of nodes, where NODES > 0 and NODES < 256 and VALIDATORS number of validators divided equally among nodes"
