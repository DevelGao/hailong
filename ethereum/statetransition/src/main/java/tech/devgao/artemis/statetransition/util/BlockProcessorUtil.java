...
import static tech.devgao.artemis.datastructures.Constants.DEPOSIT_CONTRACT_TREE_DEPTH;
import static tech.devgao.artemis.datastructures.Constants.DOMAIN_ATTESTATION;
import static tech.devgao.artemis.datastructures.Constants.DOMAIN_EXIT;
...
import static tech.devgao.artemis.statetransition.util.BeaconStateUtil.get_attestation_participants;
import static tech.devgao.artemis.statetransition.util.BeaconStateUtil.get_bitfield_bit;
import static tech.devgao.artemis.statetransition.util.BeaconStateUtil.get_block_root;
import static tech.devgao.artemis.statetransition.util.BeaconStateUtil.get_crosslink_committees_at_slot;
import static tech.devgao.artemis.statetransition.util.BeaconStateUtil.get_current_epoch;
import static tech.devgao.artemis.statetransition.util.BeaconStateUtil.get_domain;
import static tech.devgao.artemis.statetransition.util.BeaconStateUtil.get_entry_exit_effect_epoch;
import static tech.devgao.artemis.statetransition.util.BeaconStateUtil.get_randao_mix;
import static tech.devgao.artemis.statetransition.util.BeaconStateUtil.initiate_validator_exit;
import static tech.devgao.artemis.statetransition.util.BeaconStateUtil.is_double_vote;
import static tech.devgao.artemis.statetransition.util.BeaconStateUtil.is_surround_vote;
import static tech.devgao.artemis.statetransition.util.BeaconStateUtil.penalize_validator;
import static tech.devgao.artemis.statetransition.util.BeaconStateUtil.process_deposit;
import static tech.devgao.artemis.statetransition.util.BeaconStateUtil.slot_to_epoch;
import static tech.devgao.artemis.statetransition.util.BeaconStateUtil.verify_slashable_attestation;
import static tech.devgao.artemis.statetransition.util.EpochProcessorUtil.get_epoch_start_slot;
import static tech.devgao.artemis.statetransition.util.TreeHashUtil.hash_tree_root;
