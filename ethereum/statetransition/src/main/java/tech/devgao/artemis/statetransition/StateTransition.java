...
import static tech.devgao.artemis.statetransition.util.BlockProcessorUtil.process_block_header;
import static tech.devgao.artemis.statetransition.util.BlockProcessorUtil.process_eth1_data;
import static tech.devgao.artemis.statetransition.util.BlockProcessorUtil.process_operations;
import static tech.devgao.artemis.statetransition.util.BlockProcessorUtil.process_randao;
import static tech.devgao.artemis.statetransition.util.EpochProcessorUtil.process_crosslinks;
import static tech.devgao.artemis.statetransition.util.EpochProcessorUtil.process_final_updates;
import static tech.devgao.artemis.statetransition.util.EpochProcessorUtil.process_justification_and_finalization;
import static tech.devgao.artemis.statetransition.util.EpochProcessorUtil.process_registry_updates;
import static tech.devgao.artemis.statetransition.util.EpochProcessorUtil.process_rewards_and_penalties;
import static tech.devgao.artemis.statetransition.util.EpochProcessorUtil.process_slashings;
...
import tech.devgao.artemis.statetransition.util.BlockProcessingException;
