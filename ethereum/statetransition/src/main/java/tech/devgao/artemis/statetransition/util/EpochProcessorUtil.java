...
import static tech.devgao.artemis.datastructures.Constants.BASE_REWARDS_PER_EPOCH;
import static tech.devgao.artemis.datastructures.Constants.BASE_REWARD_FACTOR;
import static tech.devgao.artemis.datastructures.Constants.BASE_REWARD_PER_EPOCH;
import static tech.devgao.artemis.datastructures.Constants.EFFECTIVE_BALANCE_INCREMENT;
import static tech.devgao.artemis.datastructures.Constants.EJECTION_BALANCE;
...
import static tech.devgao.artemis.datastructures.Constants.MIN_EPOCHS_TO_INACTIVITY_PENALTY;
...
import static tech.devgao.artemis.datastructures.util.AttestationUtil.get_attesting_indices;
import static tech.devgao.artemis.datastructures.util.BeaconStateUtil.exit_validator;
...
import static tech.devgao.artemis.datastructures.util.BeaconStateUtil.get_churn_limit;
...
import static tech.devgao.artemis.datastructures.util.BeaconStateUtil.get_current_epoch_committee_count;
import static tech.devgao.artemis.datastructures.util.BeaconStateUtil.get_delayed_activation_exit_epoch;
import static tech.devgao.artemis.datastructures.util.BeaconStateUtil.get_effective_balance;
import static tech.devgao.artemis.datastructures.util.BeaconStateUtil.get_epoch_committee_count;
...
import static tech.devgao.artemis.datastructures.util.BeaconStateUtil.get_total_balance;
import static tech.devgao.artemis.datastructures.util.BeaconStateUtil.initiate_validator_exit;
import static tech.devgao.artemis.datastructures.util.BeaconStateUtil.integer_squareroot;
...
import static tech.devgao.artemis.datastructures.util.BeaconStateUtil.prepare_validator_for_withdrawal;
import static tech.devgao.artemis.datastructures.util.BeaconStateUtil.slot_to_epoch;
import static tech.devgao.artemis.datastructures.util.BeaconStateUtil.verify_bitfield;
...
import static tech.devgao.artemis.datastructures.util.CrosslinkCommitteeUtil.get_shard_delta;
