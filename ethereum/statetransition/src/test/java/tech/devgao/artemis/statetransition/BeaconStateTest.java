...
import static tech.devgao.artemis.statetransition.util.BeaconStateUtil.exit_validator;
import static tech.devgao.artemis.statetransition.util.BeaconStateUtil.generate_seed;
import static tech.devgao.artemis.statetransition.util.BeaconStateUtil.get_active_index_root;
import static tech.devgao.artemis.statetransition.util.BeaconStateUtil.get_current_epoch;
import static tech.devgao.artemis.statetransition.util.BeaconStateUtil.get_initial_beacon_state;
import static tech.devgao.artemis.statetransition.util.BeaconStateUtil.get_randao_mix;
import static tech.devgao.artemis.statetransition.util.BeaconStateUtil.is_power_of_two;
