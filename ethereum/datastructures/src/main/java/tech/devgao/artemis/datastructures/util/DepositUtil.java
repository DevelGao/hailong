...
public class DepositUtil {
  ...
  public static Deposit convertEventDepositToOperationDeposit(
      tech.devgao.artemis.pow.event.Deposit event) {
    DepositData data =
        new DepositData(
            event.getPubkey(),
  ...
  // deprecated, being used until a new validators_test_data.json can be generated
  public static tech.devgao.artemis.pow.event.Deposit convertJsonDataToEventDeposit(
      JsonElement event) {
    ...
    return new tech.devgao.artemis.pow.event.Deposit(response);
  }
}
