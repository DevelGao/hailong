...
public final class Constants {
  ...
  public static final int MAX_EXIT_DEQUEUES_PER_EPOCH = 4; // withdrawals
  ...
  public static final long FORK_CHOICE_BALANCE_INCREMENT = 1000000000L; // Gwei
  ...
  public static final int MIN_SEED_LOOKAHEAD = 1; // epochs 6.4 minutes
