...
import tech.devgao.artemis.ethereum.rlp.RLPException;
import tech.devgao.artemis.ethereum.rlp.RLPInput;
import tech.devgao.artemis.util.bytes.BytesValue;
import tech.devgao.artemis.util.bytes.DelegatingBytesValue;
...
public class Address extends DelegatingBytesValue {
  ...
  public static Address wrap(BytesValue value) {
  ...
  private static Address precompiled(int value) {
