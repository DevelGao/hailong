...
public final class EthHashTest {
  ...
  public void hashimotoLightExample() {
    ...
    Assertions
        .assertThat(Hex.toHexString(EthHash.hashimotoLight(32 * 1024, cache,
            Hex.decode("c9149cc0386e689d789a1c2f3d5d169a61a6218ed30e74414dc736e442ef3d1f"), 0L)))
        .isEqualTo("e4073cffaef931d37117cefd9afd27ea0f1cad6a981dd2605c4a1ac97c519800"
  ...
  public void prepareCache() {
    ...
    Assertions.assertThat(Hex.toHexString(buffer.array())).isEqualTo(new StringBuilder()
        .append(
