...
package tech.devgao.hailong.reference.phase0.shuffling;

import static org.junit.jupiter.api.Assertions.assertEquals;
import static tech.devgao.hailong.datastructures.util.CommitteeUtil.compute_shuffled_index;
...
public class shuffleMainnet extends TestSuite {
  ...
  @ParameterizedTest(name = "{index} Sanity shuffling (Mainnet)")
