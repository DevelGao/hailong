...
import static net.develgao.artemis.state.BeaconState.BeaconStateHelperFunctions.bytes3ToInt;
import static net.develgao.artemis.state.BeaconState.BeaconStateHelperFunctions.clamp;
import static net.develgao.artemis.state.BeaconState.BeaconStateHelperFunctions.intToBytes3;
import static net.develgao.artemis.state.BeaconState.BeaconStateHelperFunctions.shuffle;
import static net.develgao.artemis.state.BeaconState.BeaconStateHelperFunctions.split;
