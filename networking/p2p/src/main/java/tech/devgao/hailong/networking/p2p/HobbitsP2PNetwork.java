...
package tech.devgao.hailong.networking.p2p;
...
import tech.devgao.hailong.networking.p2p.hobbits.AbstractSocketHandler;
import tech.devgao.hailong.networking.p2p.hobbits.Peer;
import tech.devgao.hailong.networking.p2p.hobbits.SocketHandlerFactory;
...
public final class HobbitsP2PNetwork implements P2PNetwork {
  ...
  private final String userAgent = "Hailong SNAPSHOT";
  private State state;
