...
package tech.devgao.hailong.services.adapter;
...
import tech.devgao.hailong.services.adapter.dto.RemoteCallResponse;
import tech.devgao.hailong.services.adapter.event.OutboundEvent;
import tech.devgao.hailong.services.adapter.factory.MethodDescriptorFactory;
import tech.devgao.hailong.services.adapter.io.inbound.DefaultGrpcServer;
import tech.devgao.hailong.services.adapter.io.inbound.GrpcServer;
import tech.devgao.hailong.services.adapter.io.outbound.EventForwarder;
import tech.devgao.hailong.services.adapter.io.outbound.GrpcEventForwarder;

/** Encapsulates receiving/delivering events from/to Hailong microservices */
public class ServiceAdapter implements ServiceInterface {

  public static final String SERVICE_NAME = "tech.devgao.hailong.serviceAdapter";
